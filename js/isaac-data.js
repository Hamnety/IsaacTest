...
const ISAAC_GAME_DATA = {
    ...
    characters: {
        ...
        481: { name: "Порченный Азазель", unlockAchievement: 481, bossAchievements: [562, 625, 608, 591, 539, 563, 498], iconId: 24 },
        482: { name: "Порченный Лазарь", unlockAchievement: 482, bossAchievements: [564, 626, 609, 592, 543, 565, 499], iconId: 25 },

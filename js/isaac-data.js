...
const ISAAC_GAME_DATA = {
    ...
    // Названия челленджей и способы разблокировки
    challenges: {
        60: { name: "Beans!", unlockCondition: "Изначально открыто" },
        62: { name: "The Host", unlockCondition: "Изначально открыто" },
        63: { name: "The Family Man", unlockCondition: "Разблокировать Оно живое, и собрать первую и вторую часть ключа" },
        89: { name: "Pitch Black", unlockCondition: "Изначально открыто" },
        90: { name: "High Brow", unlockCondition: "Изначально открыто" },
        91: { name: "Head Trauma", unlockCondition: "Изначально открыто" },
        92: { name: "Darkness Falls", unlockCondition: "Разблокировать Еву, Оно Живое и Нож для жертвоприношений" },
        93: { name: "The Tank", unlockCondition: "Разблокировать Магдалену" },
        94: { name: "Solar System", unlockCondition: "Убить Сердце мамы 3 раза" },
        95: { name: "Purist", unlockCondition: "Убить маму" },
        96: { name: "Cat Got Your Tongue", unlockCondition: "Получить трансформацию Гаппи" },
        97: { name: "Demo Man", unlockCondition: "Убить Сердце мамы 9 раз" },
        98: { name: "Cursed!", unlockCondition: "Разблокировать Магдалену" },
        99: { name: "Glass Cannon", unlockCondition: "Пройти 19 испытание, убить локи, разблокировать Иуду и Оно живое" },
        100: { name: "When Life Gives You Lemons", unlockCondition: "Изначально открыто" },
        101: { name: "It's in the Cards", unlockCondition: "Изначально открыто" },
        102: { name: "Slow Roll", unlockCondition: "Изначально открыто" },
        103: { name: "Computer Savvy", unlockCondition: "Изначально открыто" },
        104: { name: "Waka Waka", unlockCondition: "Изначально открыто" },
        120: { name: "Suicide King", unlockCondition: "Разблокировать Оно живое и Лазаря" },
        224: { name: "XXXXXXXXL", unlockCondition: "Убить маму" },
        225: { name: "SPEED!", unlockCondition: "Убить маму" },
        226: { name: "Blue Bomber", unlockCondition: "Разблокировать Оно живое и взорвать 10 меченых камней" },
        227: { name: "PAY TO PLAY", unlockCondition: "Убить Айзека 11 раз за Кайна" },
        228: { name: "Have a Heart", unlockCondition: "Убить маму" },
        229: { name: "I RULE!", unlockCondition: "Получить Негатив, убить Сатану за Айзека, и убить Мега Сатану" },
        230: { name: "BRAINS!", unlockCondition: "Разблокировать Поларойд" },
        231: { name: "PRIDE DAY!", unlockCondition: "Убить маму" },
        233: { name: "Onan's Streak", unlockCondition: "Разблокировать Оно живое и Иуду" },
        234: { name: "The Guardian", unlockCondition: "Убить маму" },
        331: { name: "Backasswards", unlockCondition: "Убить Мега Сатану и разблокировать Негатив" },
        332: { name: "Aprils Fool", unlockCondition: "Убить маму" },
        333: { name: "Pokey Mans", unlockCondition: "Разблокировать Оно живое" },
        334: { name: "Ultra Hard", unlockCondition: "Убить Мега Сатану и разблокировать Негатив" },
        335: { name: "Pong", unlockCondition: "Разблокировать Поларойд" },
        517: { name: "Scat Man", unlockCondition: "Изначально открыто" },
        518: { name: "Bloody Mary", unlockCondition: "Разблокироварть Бетанни, Оно живое, Пакет с кровью" },
        519: { name: "Baptism by Fire", unlockCondition: "Убить Сатану за Беттани, Агнца за Магдалену, разблокировать Оно живое" },
        520: { name: "Isaac's Awakening", unlockCondition: "Убить Матерь" },
        521: { name: "Seeing Double", unlockCondition: "Убить Матерь" },
        522: { name: "Pica Run", unlockCondition: "Разблокировать Оно живое и Marbles" },
        531: { name: "Hot Potato", unlockCondition: "Разблокировать Порченного Забытого" },
        532: { name: "Cantripped!", unlockCondition: "Разблокировать Порченного Кайна" },
        533: { name: "Red Redemption", unlockCondition: "Разблокировать Иакова и Исава" },
        538: { name: "DELETE THIS", unlockCondition: "Разблокировать Порченного Идена" }
    }
};

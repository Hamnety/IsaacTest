...
const ISAAC_GAME_DATA = {
    ...
    // Данные челленджей
    challenges: {
        89: { name: "Pitch Black", unlockCondition: "Изначально открыто", reward: "Pitch Black", rewardAchievementId: 89 },
        90: { name: "High Brow", unlockCondition: "Изначально открыто", reward: "High Brow", rewardAchievementId: 90 },
        91: { name: "Head Trauma", unlockCondition: "Изначально открыто", reward: "Head Trauma", rewardAchievementId: 91 },
        92: { name: "Darkness Falls", unlockCondition: "Разблокировать Еву, Оно Живое и Нож для жертвоприношений", reward: "Darkness Falls", rewardAchievementId: 92 },
        93: { name: "The Tank", unlockCondition: "Разблокировать Магдалену", reward: "The Tank", rewardAchievementId: 93 },
        94: { name: "Solar System", unlockCondition: "Убить Сердце мамы 3 раза", reward: "Solar System", rewardAchievementId: 94 },
        95: { name: "Purist", unlockCondition: "Убить маму", reward: "Purist", rewardAchievementId: 95 },
        96: { name: "Cat Got Your Tongue", unlockCondition: "Получить трансформацию Гаппи", reward: "Cat Got Your Tongue", rewardAchievementId: 96 },
        97: { name: "Demo Man", unlockCondition: "Убить Сердце мамы 9 раз", reward: "Demo Man", rewardAchievementId: 97 },
        98: { name: "Cursed!", unlockCondition: "Разблокировать Магдалену", reward: "Cursed!", rewardAchievementId: 98 },
        99: { name: "Glass Cannon", unlockCondition: "Пройти 19 испытание, убить локи, разблокировать Иуду и Оно живое", reward: "Glass Cannon", rewardAchievementId: 99 },
        100: { name: "When Life Gives You Lemons", unlockCondition: "Изначально открыто", reward: "When Life Gives You Lemons", rewardAchievementId: 100 },
        101: { name: "It's in the Cards", unlockCondition: "Изначально открыто", reward: "It's in the Cards", rewardAchievementId: 101 },
        102: { name: "Slow Roll", unlockCondition: "Изначально открыто", reward: "Slow Roll", rewardAchievementId: 102 },
        103: { name: "Computer Savvy", unlockCondition: "Изначально открыто", reward: "Computer Savvy", rewardAchievementId: 103 },
        104: { name: "Waka Waka", unlockCondition: "Изначально открыто", reward: "Waka Waka", rewardAchievementId: 104 },
        120: { name: "Suicide King", unlockCondition: "Разблокировать Оно живое и Лазаря", reward: "Suicide King", rewardAchievementId: 120 },
        60: { name: "Beans!", unlockCondition: "Изначально открыто", reward: "Beans!", rewardAchievementId: 60 },
        62: { name: "The Host", unlockCondition: "Изначально открыто", reward: "The Host", rewardAchievementId: 62 },
        63: { name: "The Family Man", unlockCondition: "Разблокировать Оно живое, и собрать первую и вторую часть ключа", reward: "The Family Man", rewardAchievementId: 63 },
        224: { name: "XXXXXXXXL", unlockCondition: "Убить маму", reward: "XXXXXXXXL", rewardAchievementId: 224 },
        225: { name: "SPEED!", unlockCondition: "Убить маму", reward: "SPEED!", rewardAchievementId: 225 },
        226: { name: "Blue Bomber", unlockCondition: "Разблокировать Оно живое и взорвать 10 меченых камней", reward: "Blue Bomber", rewardAchievementId: 226 },
        227: { name: "PAY TO PLAY", unlockCondition: "Убить Айзека 11 раз за Кайна", reward: "PAY TO PLAY", rewardAchievementId: 227 },
        228: { name: "Have a Heart", unlockCondition: "Убить маму", reward: "Have a Heart", rewardAchievementId: 228 },
        229: { name: "I RULE!", unlockCondition: "Получить Негатив, убить Сатану за Айзека, и убить Мега Сатану", reward: "I RULE!", rewardAchievementId: 229 },
        230: { name: "BRAINS!", unlockCondition: "Разблокировать Поларойд", reward: "BRAINS!", rewardAchievementId: 230 },
        231: { name: "PRIDE DAY!", unlockCondition: "Убить маму", reward: "PRIDE DAY!", rewardAchievementId: 231 },
        233: { name: "Onan's Streak", unlockCondition: "Разблокировать Оно живое и Иуду", reward: "Onan's Streak", rewardAchievementId: 233 },
        234: { name: "The Guardian", unlockCondition: "Убить маму", reward: "The Guardian", rewardAchievementId: 234 },
        331: { name: "Backasswards", unlockCondition: "Убить Мега Сатану и разблокировать Негатив", reward: "Backasswards", rewardAchievementId: 331 },
        332: { name: "Aprils Fool", unlockCondition: "Убить маму", reward: "Aprils Fool", rewardAchievementId: 332 },
        333: { name: "Pokey Mans", unlockCondition: "Разблокировать Оно живое", reward: "Pokey Mans", rewardAchievementId: 333 },
        334: { name: "Ultra Hard", unlockCondition: "Убить Мега Сатану и разблокировать Негатив", reward: "Ultra Hard", rewardAchievementId: 334 },
        335: { name: "Pong", unlockCondition: "Разблокировать Поларойд", reward: "Pong", rewardAchievementId: 335 },
        517: { name: "Scat Man", unlockCondition: "Изначально открыто", reward: "Scat Man", rewardAchievementId: 517 },
        518: { name: "Bloody Mary", unlockCondition: "Разблокироварть Бетанни, Оно живое, Пакет с кровью", reward: "Bloody Mary", rewardAchievementId: 518 },
        519: { name: "Baptism by Fire", unlockCondition: "Убить Сатану за Беттани, Агнца за Магдалену, разблокировать Оно живое", reward: "Baptism by Fire", rewardAchievementId: 519 },
        520: { name: "Isaac's Awakening", unlockCondition: "Убить Матерь", reward: "Isaac's Awakening", rewardAchievementId: 520 },
        521: { name: "Seeing Double", unlockCondition: "Убить Матерь", reward: "Seeing Double", rewardAchievementId: 521 },
        522: { name: "Pica Run", unlockCondition: "Разблокировать Оно живое и Marbles", reward: "Pica Run", rewardAchievementId: 522 },
        531: { name: "Hot Potato", unlockCondition: "Разблокировать Порченного Забытого", reward: "Hot Potato", rewardAchievementId: 531 },
        532: { name: "Cantripped!", unlockCondition: "Разблокировать Порченного Кайна", reward: "Cantripped!", rewardAchievementId: 532 },
        533: { name: "Red Redemption", unlockCondition: "Разблокировать Иакова и Исава", reward: "Red Redemption", rewardAchievementId: 533 },
        538: { name: "DELETE THIS", unlockCondition: "Разблокировать Порченного Идена", reward: "DELETE THIS", rewardAchievementId: 538 }
    }
};

...
const ISAAC_GAME_DATA = {
    ...
    // Данные о челленджах
    challenges: {
        60: { name: "Beans!", unlockCondition: "Изначально открыто", achievementId: 60, achievementName: "Beans!" },
        62: { name: "The Host", unlockCondition: "Изначально открыто", achievementId: 62, achievementName: "The Host" },
        63: { name: "The Family Man", unlockCondition: "Разблокировать Оно живое, и собрать первую и вторую часть ключа", achievementId: 63, achievementName: "The Family Man" },
        89: { name: "Pitch Black", unlockCondition: "Изначально открыто", achievementId: 89, achievementName: "Pitch Black" },
        90: { name: "High Brow", unlockCondition: "Изначально открыто", achievementId: 90, achievementName: "High Brow" },
        91: { name: "Head Trauma", unlockCondition: "Изначально открыто", achievementId: 91, achievementName: "Head Trauma" },
        92: { name: "Darkness Falls", unlockCondition: "Разблокировать Еву, Оно Живое и Нож для жертвоприношений", achievementId: 92, achievementName: "Darkness Falls" },
        93: { name: "The Tank", unlockCondition: "Разблокировать Магдалену", achievementId: 93, achievementName: "The Tank" },
        94: { name: "Solar System", unlockCondition: "Убить Сердце мамы 3 раза", achievementId: 94, achievementName: "Solar System" },
        95: { name: "Purist", unlockCondition: "Убить маму", achievementId: 95, achievementName: "Purist" },
        96: { name: "Cat Got Your Tongue", unlockCondition: "Получить трансформацию Гаппи", achievementId: 96, achievementName: "Cat Got Your Tongue" },
        97: { name: "Demo Man", unlockCondition: "Убить Сердце мамы 9 раз", achievementId: 97, achievementName: "Demo Man" },
        98: { name: "Cursed!", unlockCondition: "Разблокировать Магдалену", achievementId: 98, achievementName: "Cursed!" },
        99: { name: "Glass Cannon", unlockCondition: "Пройти 19 испытание, убить локи, разблокировать Иуду и Оно живое", achievementId: 99, achievementName: "Glass Cannon" },
        100: { name: "When Life Gives You Lemons", unlockCondition: "Изначально открыто", achievementId: 100, achievementName: "When Life Gives You Lemons" },
        101: { name: "It's in the Cards", unlockCondition: "Изначально открыто", achievementId: 101, achievementName: "It's in the Cards" },
        102: { name: "Slow Roll", unlockCondition: "Изначально открыто", achievementId: 102, achievementName: "Slow Roll" },
        103: { name: "Computer Savvy", unlockCondition: "Изначально открыто", achievementId: 103, achievementName: "Computer Savvy" },
        104: { name: "Waka Waka", unlockCondition: "Изначально открыто", achievementId: 104, achievementName: "Waka Waka" },
        120: { name: "Suicide King", unlockCondition: "Разблокировать Оно живое и Лазаря", achievementId: 120, achievementName: "Suicide King" },
        224: { name: "XXXXXXXXL", unlockCondition: "Убить маму", achievementId: 224, achievementName: "Gold Heart" },
        225: { name: "SPEED!", unlockCondition: "Убить маму", achievementId: 225, achievementName: "SPEED!" },
        226: { name: "Blue Bomber", unlockCondition: "Разблокировать Оно живое и взорвать 10 меченых камней", achievementId: 226, achievementName: "Blue Bomber" },
        227: { name: "PAY TO PLAY", unlockCondition: "Убить Айзека 11 раз за Кайна", achievementId: 227, achievementName: "PAY TO PLAY" },
        228: { name: "Have a Heart", unlockCondition: "Убить маму", achievementId: 228, achievementName: "Have a Heart" },
        229: { name: "I RULE!", unlockCondition: "Получить Негатив, убить Сатану за Айзека, и убить Мега Сатану", achievementId: 229, achievementName: "I RULE!" },
        230: { name: "BRAINS!", unlockCondition: "Разблокировать Поларойд", achievementId: 230, achievementName: "BRAINS!" },
        231: { name: "PRIDE DAY!", unlockCondition: "Убить маму", achievementId: 231, achievementName: "PRIDE DAY!" },
        233: { name: "Onan's Streak", unlockCondition: "Разблокировать Оно живое и Иуду", achievementId: 233, achievementName: "Onan's Streak" },
        234: { name: "The Guardian", unlockCondition: "Убить маму", achievementId: 234, achievementName: "The Guardian" },
        331: { name: "Backasswards", unlockCondition: "Убить Мега Сатану и разблокировать Негатив", achievementId: 331, achievementName: "Backasswards" },
        332: { name: "Aprils Fool", unlockCondition: "Убить маму", achievementId: 332, achievementName: "Aprils Fool" },
        333: { name: "Pokey Mans", unlockCondition: "Разблокировать Оно живое", achievementId: 333, achievementName: "Pokey Mans" },
        334: { name: "Ultra Hard", unlockCondition: "Убить Мега Сатану и разблокировать Негатив", achievementId: 334, achievementName: "Ultra Hard" },
        335: { name: "Pong", unlockCondition: "Разблокировать Поларойд", achievementId: 335, achievementName: "Pong" },
        517: { name: "Scat Man", unlockCondition: "Изначально открыто", achievementId: 517, achievementName: "Scat Man" },
        518: { name: "Bloody Mary", unlockCondition: "Разблокироварть Бетанни, Оно живое, Пакет с кровью", achievementId: 518, achievementName: "Bloody Mary" },
        519: { name: "Baptism by Fire", unlockCondition: "Убить Сатану за Беттани, Агнца за Магдалену, разблокировать Оно живое", achievementId: 519, achievementName: "Baptism by Fire" },
        520: { name: "Isaac's Awakening", unlockCondition: "Убить Матерь", achievementId: 520, achievementName: "Isaac's Awakening" },
        521: { name: "Seeing Double", unlockCondition: "Убить Матерь", achievementId: 521, achievementName: "Seeing Double" },
        522: { name: "Pica Run", unlockCondition: "Разблокировать Оно живое и Marbles", achievementId: 522, achievementName: "Pica Run" },
        531: { name: "Hot Potato", unlockCondition: "Разблокировать Порченного Забытого", achievementId: 531, achievementName: "Hot Potato" },
        532: { name: "Cantripped!", unlockCondition: "Разблокировать Порченного Кайна", achievementId: 532, achievementName: "Cantripped!" },
        533: { name: "Red Redemption", unlockCondition: "Разблокировать Иакова и Исава", achievementId: 533, achievementName: "Red Redemption" },
        538: { name: "DELETE THIS", unlockCondition: "Разблокировать Порченного Идена", achievementId: 538, achievementName: "DELETE THIS" }
    }
};
